...
import { Building2, Users, Clock, CheckCircle2, ChevronRight, ChevronLeft, Loader2 } from 'lucide-react'
          ...
          return (
            <div key={p.numero} className="flex items-center flex-1">
              <div className="flex flex-col items-center gap-1">
                ...
                >
                  {completado ? <CheckCircle2 className="w-5 h-5" /> : p.numero}
                </div>
              ...
              {i < PASOS.length - 1 && (
                <div className={`flex-1 h-0.5 mx-2 ${paso > p.numero ? 'bg-blue-600' : 'bg-slate-200'}`} />
              )}
            </div>
          )
        })}
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 sm:p-8">
        ...
        {paso === 1 && (
          <div className="space-y-5">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">Confirmemos los datos básicos de tu clínica para empezar.</p>
            </div>
            <Input
        ...
        {paso === 4 && (
          <div className="text-center space-y-5 py-2">
            ...
            <div>
              <h2 className="text-xl font-bold text-slate-900">¡Tu clínica está lista!</h2>
            ...
            <div className="bg-slate-50 rounded-xl p-4 text-left space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm text-slate-700">
                ...
                Datos básicos de la clínica guardados
              </div>
              <div className="flex items-center gap-2 text-sm text-slate-700">
                <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0" />
