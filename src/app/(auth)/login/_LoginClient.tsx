...
import { CalendarDays, Mail, Lock, FileText, Sparkles } from 'lucide-react'
...
export default function LoginClient() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { rol } = usuario as { rol: string; es_doctor: boolean }

    // Admin + doctor: directo al panel admin (incluye acceso médico desde sidebar)
    // La pantalla de selección de rol se elimina — es fricción innecesaria
    // para dentistas particulares que son admin y doctor a la vez.
    if (rol === 'doctor') {
